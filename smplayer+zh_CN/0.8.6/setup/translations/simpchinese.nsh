...
!ifdef WIN64
${LangFileString} Section_MPlayerCodecs_Desc "在此版本中不支持二进制解码器。"
!else
...
${LangFileString} Section_ResetSettings_Desc "删除前次安装遗留的 SMPlayer 配置文件。"
...
${LangFileString} Reinstall_Msg5 "恢复我的 SMPlayer 设置为默认值"
